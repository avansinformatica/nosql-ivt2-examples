...
const description =
  "<p>This server allows users to register themselves and to get a list of information..</p>";
...
// Add CORS headers
logger.info(
  `Setting process.env.ALLOW_ORIGIN to '${process.env.ALLOW_ORIGIN}'`
);
app.use(function(req, res, next) {
  res.setHeader(
    "Access-Control-Allow-Origin",
    process.env.ALLOW_ORIGIN || "http://localhost:4200"
  );
  res.setHeader(
